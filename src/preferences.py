...
def get_skins():
	...
	installation_dir = '/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator/skins'
...
class CM(Gtk.Dialog): # needs GTK, Python, Webkit-GTK
	def __init__(self):
		#***************************************************************
		Gtk.Dialog.__init__(self,'my-weather-indicator | '+_('Preferences'),None,Gtk.DialogFlags.MODAL | Gtk.DialogFlags.DESTROY_WITH_PARENT,(Gtk.STOCK_CANCEL, Gtk.ResponseType.REJECT,Gtk.STOCK_OK, Gtk.ResponseType.ACCEPT))
		...
		table11.attach(self.checkbutton11,0,1,0,1,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************
		self.checkbutton10 = Gtk.CheckButton.new_with_label(_('Auto Location'))
		self.checkbutton10.connect('toggled',self.on_checkbutton10_toggled)
		table11.attach(self.checkbutton10,0,1,1,2,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************
		label11 = Gtk.Label.new(_('Locality')+':')
		label11.set_alignment(0, 0.5)
		table11.attach(label11,0,1,2,3,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#
		self.entry11 = Gtk.Entry()
		#self.entry11.set_editable(False)
		table11.attach(self.entry11,1,2,2,3,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************
		self.button10 = Gtk.Button.new_with_label(_('Search Location'))		
		self.button10.connect('clicked',self.search_location)
		table11.attach(self.button10,2,3,2,3,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************
		self.checkbutton12 = Gtk.CheckButton.new_with_label(_('Show temperature'))		
		table11.attach(self.checkbutton12,0,1,3,4,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)			
		#***************************************************************
		self.checkbutton13 = Gtk.CheckButton.new_with_label(_('Show notifications'))		
		table11.attach(self.checkbutton13,1,2,3,4,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)			
		#***************************************************************
		...
		table12.attach(self.checkbutton14,0,1,0,1,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)			
		#***************************************************************
		self.checkbutton15 = Gtk.CheckButton.new_with_label(_('Hide indicator when show widget'))		
		table12.attach(self.checkbutton15,1,2,0,1,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)			
		#***************************************************************
		self.checkbutton16 = Gtk.CheckButton.new_with_label(_('Widget on top'))		
		table12.attach(self.checkbutton16,0,1,1,2,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)			
		#***************************************************************
		self.checkbutton17 = Gtk.CheckButton.new_with_label(_('Show in taskbar'))		
		table12.attach(self.checkbutton17,1,2,1,2,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)			
		#***************************************************************		
		self.checkbutton18 = Gtk.CheckButton.new_with_label(_('On all desktops'))		
		table12.attach(self.checkbutton18,0,1,2,3,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)			
		#***************************************************************		
		...
		table12.attach(self.comboboxskin1,1,2,2,3,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)			
		#***************************************************************
		#***************************************************************
		...
		table21.attach(self.checkbutton21,0,1,0,1,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************
		label21 = Gtk.Label.new(_('Locality')+':')
		label21.set_alignment(0, 0.5)
		table21.attach(label21,0,1,1,2,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#
		self.entry21 = Gtk.Entry()
		#self.entry21.set_editable(False)
		table21.attach(self.entry21,1,2,1,2,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************
		#***************************************************************
		self.button20 = Gtk.Button.new_with_label(_('Search Location'))		
		self.button20.connect('clicked',self.search_location2)
		table21.attach(self.button20,2,3,1,2,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)	
		#***************************************************************
		self.checkbutton22 = Gtk.CheckButton.new_with_label(_('Show temperature'))	
		table21.attach(self.checkbutton22,0,1,2,3,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)	
		#***************************************************************
		self.checkbutton23 = Gtk.CheckButton.new_with_label(_('Show notifications'))		
		table21.attach(self.checkbutton23,1,2,2,3,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)							
		#***************************************************************
		#***************************************************************
		...
		table22.attach(self.checkbutton24,0,1,0,1,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)			
		#***************************************************************
		self.checkbutton25 = Gtk.CheckButton.new_with_label(_('Hide indicator when show widget'))		
		table22.attach(self.checkbutton25,1,2,0,1,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)			
		#***************************************************************
		self.checkbutton26 = Gtk.CheckButton.new_with_label(_('Widget on top'))		
		table22.attach(self.checkbutton26,0,1,1,2,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)			
		#***************************************************************
		self.checkbutton27 = Gtk.CheckButton.new_with_label(_('Show in taskbar'))		
		table22.attach(self.checkbutton27,1,2,1,2,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)			
		#***************************************************************		
		self.checkbutton28 = Gtk.CheckButton.new_with_label(_('On all desktops'))		
		table22.attach(self.checkbutton28,0,1,2,3,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)			
		#***************************************************************		
		...
		table22.attach(self.comboboxskin2,1,2,2,3,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)			
		...
		#***************************************************************
		'''
		self.radiobutton251 = Gtk.RadioButton(group=None)
		self.radiobutton251.set_sensitive(False)
		image_wunderground = Gtk.Image()
		image_wunderground.set_from_file(comun.UNDERGROUNDLOGO)
		image_wunderground.connect('button-release-event',self.on_image_wunderground_clicked)
		self.radiobutton251.add(image_wunderground)
		table25.attach(self.radiobutton251,0,1,0,1, xpadding=5, ypadding=5)
		self.radiobutton252 = Gtk.RadioButton(group=self.radiobutton251)
		image_wgoogle = Gtk.Image()
		image_wgoogle.set_from_file(comun.GOOGLELOGO)
		self.radiobutton252.add(image_wgoogle)
		table25.attach(self.radiobutton252,0,1,1,2, xpadding=5, ypadding=5)
		'''
		owmframe = Gtk.Frame()
		...
		wwobox.attach(self.radiobutton252,0,1,0,1, xpadding=5, ypadding=5)		
		...
		buttonwwokey.set_tooltip_text(_('Click to activate World Weather Online'))
		buttonwwokey.connect('clicked',self.on_buttonwwokey_clicked)
		wwobox.attach(buttonwwokey,2,3,0,1, xoptions=Gtk.AttachOptions.SHRINK, yoptions=Gtk.AttachOptions.SHRINK,xpadding=5, ypadding=5)		
		...
		#table25.attach(self.radiobutton254,1,2,0,1, xpadding=5, ypadding=5)
		self.wukey = Gtk.Entry()
		self.wukey.set_tooltip_text(_('Input Weather Underground key'))
		#ubox.pack_start(self.wukey,True,True,0)
		wubox.attach(self.wukey,1,2,0,1, xpadding=5, ypadding=5)		
		buttonwukey = Gtk.Button(_('Activate'))
		buttonwukey.set_tooltip_text(_('Click to activate Weather Underground'))
		buttonwukey.connect('clicked',self.on_buttonwukey_clicked)
		wubox.attach(buttonwukey,2,3,0,1, xoptions=Gtk.AttachOptions.SHRINK, yoptions=Gtk.AttachOptions.SHRINK,xpadding=5, ypadding=5)		
		#***************************************************************
		vbox2 = Gtk.VBox(spacing = 5)
		vbox2.set_border_width(5)
		frame2 = Gtk.Frame()
		...
		table2.attach(label3,0,1,0,1,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************
		...
		if sys.version_info[0] == 3:	
			...
			self.liststore3.append([unichr(176) + ' ' + _('Celsius'),'C'])
			self.liststore3.append([unichr(176) + ' ' + _('Fahrenheit'),'F'])
			self.liststore3.append([_('Kelvin'),'K'])
		...
		table2.attach(self.combobox3,1,2,0,1,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************
		label32 = Gtk.Label.new(_('Pressure')+':')
		label32.set_alignment(0, 0.5)
		table2.attach(label32,0,1,1,2,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************
		...
		table2.attach(self.combobox32,1,2,1,2,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************		
		label33 = Gtk.Label.new(_('Visibility')+':')
		label33.set_alignment(0, 0.5)
		table2.attach(label33,0,1,2,3,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************
		...
		table2.attach(self.combobox33,1,2,2,3,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************		
		label31 = Gtk.Label.new(_('Wind velocity')+':')
		label31.set_alignment(0, 0.5)
		table2.attach(label31,0,1,3,4,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************		
		...
		table2.attach(self.combobox31,1,2,3,4,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************		
		label34 = Gtk.Label.new(_('Rain Gauge')+':')
		label34.set_alignment(0, 0.5)
		table2.attach(label34,0,1,4,5,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************
		...
		table2.attach(self.combobox34,1,2,4,5,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************		
		label35 = Gtk.Label.new(_('Snow Gauge')+':')
		label35.set_alignment(0, 0.5)
		table2.attach(label35,0,1,5,6,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************
		...
		table2.attach(self.combobox35,1,2,5,6,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************		
		label36 = Gtk.Label.new(_('Time Format')+':')
		label36.set_alignment(0, 0.5)
		table2.attach(label36,0,1,6,7,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************
		...
		table2.attach(self.combobox36,1,2,6,7,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************		
		...
		table3.attach(self.checkbutton1,0,2,0,1,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)

		label41 = Gtk.Label.new(_('Refresh frequency')+':')
		label41.set_alignment(0, 0.5)
		table3.attach(label41,0,1,1,2,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		...
		table3.attach(self.combobox45,1,2,1,2,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************
		label31 = Gtk.Label.new(_('Select icon theme')+':')
		label31.set_alignment(0,0.5)
		table3.attach(label31,0,2,2,3,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		self.radiobutton31 = Gtk.RadioButton(group=None)
		image1 = Gtk.Image()
		image1.set_from_file(os.path.join(comun.ICONDIR,'mwil-mostly-sunny.png'))
		self.radiobutton31.add(image1)				
		table3.attach(self.radiobutton31,0,1,3,4,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		self.radiobutton32 = Gtk.RadioButton(group=self.radiobutton31)
		image2 = Gtk.Image()
		image2.set_from_file(os.path.join(comun.ICONDIR,'mwid-mostly-sunny.png'))
		self.radiobutton32.add(image2)
		table3.attach(self.radiobutton32,1,2,3,4,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)
		#***************************************************************		
		self.checkbutton11.set_active(True)
		self.checkbutton21.set_active(True)
		#***************************************************************				
		if os.path.exists(os.path.join(os.getenv("HOME"),".config/autostart/my-weather-indicator-autostart.desktop")):
	...
	def set_sensitive_frame1(self,sensitive):
		...
		#self.button11.set_sensitive(sensitive)
	...
	def set_sensitive_frame2(self,sensitive):
		...
		#self.button21.set_sensitive(sensitive)
	...
	def on_checkbutton11_toggled(self,widget):
		...
		elif (self.checkbutton11.get_active() == True and self.checkbutton21.get_active() == False):
	...
	def on_checkbutton14_toggled(self,widget):
		self.checkbutton15.set_sensitive(self.checkbutton14.get_active() == True)
		self.checkbutton16.set_sensitive(self.checkbutton14.get_active() == True)
		self.checkbutton17.set_sensitive(self.checkbutton14.get_active() == True)
		self.checkbutton18.set_sensitive(self.checkbutton14.get_active() == True)
		self.comboboxskin1.set_sensitive(self.checkbutton14.get_active() == True)
	...
	def on_checkbutton21_toggled(self,widget):
		...
		if self.checkbutton21.get_active() == False:
			self.checkbutton11.set_sensitive(False)
		elif (self.checkbutton21.get_active() == True and self.checkbutton11.get_active() == False):
			self.checkbutton21.set_sensitive(False)
		elif self.checkbutton11.get_sensitive() == False:
			self.checkbutton11.set_sensitive(True)

	def on_checkbutton24_toggled(self,widget):
		self.checkbutton25.set_sensitive(self.checkbutton24.get_active() == True)
		self.checkbutton26.set_sensitive(self.checkbutton24.get_active() == True)
		self.checkbutton27.set_sensitive(self.checkbutton24.get_active() == True)
		self.checkbutton28.set_sensitive(self.checkbutton24.get_active() == True)
		self.comboboxskin2.set_sensitive(self.checkbutton24.get_active() == True)
	...
	def save_preferences(self):
		configuration = Configuration()
		if self.checkbutton11.get_active() and (len(self.entry11.get_text()) == 0 or self.latitude == None or self.latitude == 0 or self.longitude == None or self.longitude == 0):
		...
		if self.checkbutton21.get_active() and (len(self.entry21.get_text()) == 0 or self.latitude2 == None or self.latitude2 == 0 or self.longitude2 == None or self.longitude2 == 0):
		...
		configuration.set('show-notifications',self.checkbutton13.get_active())
		...
		configuration.set('skin1',get_selected_value_in_combo(self.comboboxskin1))
		#
		...
		configuration.set('show-notifications2',self.checkbutton23.get_active())
		...
		configuration.set('skin2',get_selected_value_in_combo(self.comboboxskin2))		
		#
		...
		if len(wukey)>0:
			...
			if wu.test_connection():			
				...
				if self.radiobutton254.get_active():
					configuration.set('weather-service','openweathermap')
		configuration.set('temperature',get_selected_value_in_combo(self.combobox3))
		configuration.set('pressure',get_selected_value_in_combo(self.combobox32))
		configuration.set('visibility',get_selected_value_in_combo(self.combobox33))
		configuration.set('wind',get_selected_value_in_combo(self.combobox31))
		configuration.set('rain',get_selected_value_in_combo(self.combobox34))
		configuration.set('snow',get_selected_value_in_combo(self.combobox35))
		configuration.set('24h',get_selected_value_in_combo(self.combobox36))
		configuration.set('refresh',get_selected_value_in_combo(self.combobox45))
		configuration.set('icon-light',self.radiobutton31.get_active())
		print('Saving...')
		configuration.save()
		#
		filestart = os.path.join(os.getenv("HOME"),".config/autostart/my-weather-indicator-autostart.desktop")
