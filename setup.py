...
DATA_FILES = [
	...
	('/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator',glob.glob('src/*')),
	('/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator',['debian/changelog']),
	('/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator/logos',glob.glob('data/logos/*.png')),
	('/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator/social',glob.glob('data/social/*.svg')),
	('/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator/images',glob.glob('data/images/*.png')),
	('/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator/images',glob.glob('data/images/*.svg')),
	('/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator/icons',glob.glob('data/icons/*.png')),
	('/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator/wimages',glob.glob('data/wimages/*.png')),
	('/usr/share/fonts/truetype/encode-sans',glob.glob('data/fonts/encode-sans/*.ttf')),
	('/usr/share/fonts/truetype/mplus-1c',glob.glob('data/fonts/mplus-1c/*.ttf')),
	('/usr/share/fonts/truetype/existence',glob.glob('data/fonts/existence/*.ttf')),
	('/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator/skins/aclock',glob.glob('data/skins/aclock/*')),
	('/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator/skins/allinone',glob.glob('data/skins/allinone/*')),
	('/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator/skins/anotherone',glob.glob('data/skins/anotherone/*')),
	('/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator/skins/super',glob.glob('data/skins/super/*')),
	('/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator/skins/full',glob.glob('data/skins/full/*')),
	('/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator/skins/medium',glob.glob('data/skins/medium/*')),
	('/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator/skins/little',glob.glob('data/skins/little/*')),
	('/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator/skins/superclock',glob.glob('data/skins/superclock/*')),
	('/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator/skins/simple',glob.glob('data/skins/simple/*')),
	('/opt/extras.ubuntu.com/my-weather-indicator/share/pixmaps',['data/images/my-weather-indicator.png']),
	('/opt/extras.ubuntu.com/my-weather-indicator/share/my-weather-indicator',['data/my-weather-indicator-autostart.desktop']),
	('/usr/share/applications',['data/extras-my-weather-indicator.desktop']),
	]
